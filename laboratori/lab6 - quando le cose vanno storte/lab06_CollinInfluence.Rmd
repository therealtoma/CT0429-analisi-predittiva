...
Infatti ci si aspetta che i residui standardizzato seguano un distribuzione normale standard e si più controllare velocemente se ci sono molti valori al di fuori dell'intervallo (-2,2), che per una normale standard dovrebbe contenere il $\approx$ 95% dei dati 
