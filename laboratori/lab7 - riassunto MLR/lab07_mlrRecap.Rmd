...
In termini di $\text{RMSE}_{LOOCV}$ il modello basato sulle variabili trasformate ha una performance migliore: 
...
Scegliamo come modello "finale" il modello basato sulle variabili trasformate, inserendo anche la variabile `BFI` nella sua forma originale oltre che la forma al quadrato: 
